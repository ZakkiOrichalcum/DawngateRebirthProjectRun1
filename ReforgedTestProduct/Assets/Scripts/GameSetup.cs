...
//	}
	...
	{
		//Spawn Same Player
		GameObject player = PhotonNetwork.Instantiate ("BluePlayer", Vector3.up, Quaternion.identity, 0) as GameObject;
		player.GetComponent<Unit>().Init( "Hero", "Hero", 500.0, 5, 3.4, 54, 2, 1.5f, 0.5f, 16, 2, 15, 2, 5, 3, 0.2f, 0.8f,0.2f,0.5f);
	}
}